...
#### <a id="en_a2">Extruder / Tool Chain </a>
...
#### <a id="en_a4">Virtual extruder / Virtual Tool / VTool </a>
...
## <a id="en_b">How to set mixing ratio of virtual extruder (for 4-IN-1-OUT mix Color hot end) </a>
...
### <a id="en_b1">Set mixing ratio by adding command </a>
...
## <a id="en_c">[:book: Auto mixing color operation manual][auto_mixing] </a>
...
## <a id="en_d">[:book: Mixed multi color operation manual][mixed_multi_color] </a>
...
#### <a id="es_a2">Extrusora/Cadena de herramientas </a>
...
#### <a id="es_a3">Proporción de mezcla </a>
...
#### <a id="es_a4">Extrusora virtual/Herramienta virtual/VTool </a>
...
## <a id="es_b">Cómo configurar la proporción de mezcla del extrusor virtual (para el extremo caliente de color de mezcla 4 EN 1 SALIDA) </a>
...
### <a id="es_b1">Establezca la proporción de mezcla agregando el comando </a>
...
## <a id="es_c">[:book: Manual de operación de mezcla automática de colores][auto_mixing] </a>
...
## <a id="es_d">[:book: Manual de funcionamiento de varios colores mixtos][mixed_multi_color] </a>
...
#### <a id="pt_a2">Extrusora / Cadeia de ferramentas </a>
...
#### <a id="pt_a3">Proporção de mistura </a>
...
#### <a id="pt_a4">Extrusora virtual / Ferramenta virtual / VTool </a>
...
## <a id="pt_b">Como definir a proporção de mistura da extrusora virtual (para mix 4-IN-1-OUT Color hot end) </a>
...
### <a id="pt_b1">Defina a taxa de mistura adicionando o comando </a>
...
## <a id="pt_c">[:book: Manual de operação de mistura automática de cores][auto_mixing] </a>
...
## <a id="pt_d">[:book: Manual de operação multicolorido misto][mixed_multi_color] </a>
...
#### <a id="fr_a2">Extrudeuse / Chaîne d'outils </a>
...
#### <a id="fr_a3">Rapport de mélange </a>
...
#### <a id="fr_a4">Extrudeuse virtuelle / Outil Virtuel / VTool </a>
...
## <a id="fr_b">Comment définir le rapport de mélange de l'extrudeuse virtuelle (pour l'extrémité chaude 4-IN-1-OUT mix Color) </a>
...
### <a id="fr_b1">Définir le rapport de mélange en ajoutant une commande </a>
...
## <a id="fr_c">[:book: Manuel d'utilisation du mélange automatique des couleurs][auto_mixing] </a>
...
## <a id="fr_d">[:book: Manuel d'utilisation multicolore mixte][mixed_multi_color] </a>
...
#### <a id="de_a4">Virtueller Extruder / Virtuelles Werkzeug / VTool </a>
...
## <a id="de_b">So legen Sie das Mischverhältnis des virtuellen Extruders fest (für 4-IN-1-OUT-Mix-Color-Hot-End) </a>
...
### <a id="de_b1">Mischverhältnis durch Hinzufügen eines Befehls festlegen </a>
...
## <a id="de_c">[:book: Bedienungsanleitung für automatische Farbmischung][auto_mixing] </a>
...
## <a id="de_d">[:book: Bedienungsanleitung für gemischte Mehrfarben][mixed_multi_color] </a>
...
#### <a id="it_a2">Estrusore/Catena portautensili </a>
...
#### <a id="it_a3">Rapporto di miscelazione </a>
...
#### <a id="it_a4">Estrusore virtuale/Strumento virtuale/VTool </a>
...
## <a id="it_b">Come impostare il rapporto di miscelazione dell'estrusore virtuale (per hot end colore mix 4-IN-1-OUT) </a>
...
### <a id="it_b1">Imposta il rapporto di miscelazione aggiungendo il comando </a>
...
## <a id="it_c">[:book: Manuale operativo per la miscelazione automatica del colore][auto_mixing] </a>
...
## <a id="it_d">[:book: Manuale operativo multicolore misto][mixed_multi_color] </a>
...
#### <a id="ru_a2">Экструдер/Цепочка инструментов </a>
...
#### <a id="ru_a3">Пропорции смешивания </a>
...
#### <a id="ru_a4">Виртуальный экструдер/Виртуальный инструмент/VTool </a>
...
## <a id="ru_b">Как установить соотношение смешивания виртуального экструдера (для смесителя 4-В-1-ВЫХ Цветной горячий конец) </a>
...
### <a id="ru_b1">Установите соотношение смешивания, добавив команду </a>
...
## <a id="ru_c">[:book: Руководство по эксплуатации автоматического смешивания цветов][auto_mixing] </a>
...
## <a id="ru_d">[:book: Руководство по эксплуатации смешанного многоцветного цвета][mixed_multi_color] </a>
...
#### <a id="jp_a4">仮想押出機 / 仮想ツール / VTool </a>
...
## <a id="jp_b">仮想押し出し機の混合比を設定する方法 (4-IN-1-OUT ミックス カラー ホット エンド用) </a>
...
### <a id="jp_b1">コマンドを追加して混合比を設定する </a>
...
#### <a id="kr_a4">가상 압출기/가상 도구/VTool </a>
...
## <a id="kr_b">가상압출기 혼합비 설정방법 (4-IN-1-OUT 믹스 컬러 핫엔드의 경우) </a>
...
### <a id="kr_b1">명령어를 추가하여 혼합 비율 설정 </a>
